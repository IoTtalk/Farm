...
void CIRRecvCounter::IRRecvCount(int nCycleTimes=1){
    int nPinCurStatus;
    //for(int cycle=0;cycle<=nCycleTimes; cycle++) nPinCurStatus = GetPinStatus(); 
    nPinCurStatus = GetPinStatus();    
